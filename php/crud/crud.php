        ...
        $layout .= "<div class='card max-width350 card-index m-2'>
                ...
                <div class='card-body'>
                    ...
                    <div class='text-button d-flex'>
                        <a href='details.php?id={$rowP['id']}' class='btn btn-success pub-link'>Details</a>
                        <a href='update.php?id={$rowP['id']}' class='btn btn-success pub-link mx-1'>Edit</a>
                        <a href='delete.php?id={$rowP['id']}' class='btn btn-success pub-link'>Delete</a>
                    </div>
                </div>
            </div>";
    }
...
<body>
    <div class="container">
        ...
        <div class="create-button">
            <a href="create.php" class="btn btn-success pub-link">Add new pet</a>
        </div>
